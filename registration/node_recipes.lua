...
minetest.register_craft({
  ...
  recipe = {
    {i.clay,  i.obsidian,     i.clay},
    {i.steel, i.empty_bucket, i.steel},
    {i.steel, i.empty_bucket, i.steel},
  }
})
...
minetest.register_craft({
  ...
  recipe = {
    {L("silverin_plate"), i.chest,          L("silverin_plate")},
...
minetest.register_craft({
  ...
  recipe = {
    {L("silverin_plate"), L("optic_cable"), L("silverin_plate")},
    {"",                  "",               ""},
    {L("silverin_plate"), i.cactus,         L("silverin_plate")},
  }
})
...
minetest.register_craft({
  ...
  recipe = {
    {L("silverin_plate"), i.chest,          L("silverin_plate")},
    {L("optic_cable"),    L("photonizer"),  L("silverin_circuit")},
    {L("silverin_plate"), i.crystal,        L("silverin_plate")},
  }
})
...
minetest.register_craft({
  ...
  recipe = {
    ...
    {L("optic_cable"),    L("photonizer"),  L("silverin_circuit")},
    {L("silverin_plate"), i.water_bucket,   L("silverin_plate")},
  },
  replacements = {
    {i.water_bucket, i.empty_bucket},
    {i.lava_bucket,  i.empty_bucket},
  }
})
...
minetest.register_craft({
  ...
  recipe = {
    {L("silverin_plate"), "",             L("silverin_plate")},
    {L("optic_cable"),    i.empty_bucket, L("photonizer")},
    {L("silverin_plate"), "",             L("silverin_plate")},
  }
})
...
minetest.register_craft({
  ...
  recipe = {
    {i.obsidian,        L("silverin_plate"),  i.obsidian},
    {L("optic_cable"),  i.empty_bucket,       L("photonizer")},
    {i.obsidian,        L("silverin_plate"),  i.obsidian},
  }
})
...
minetest.register_craft({
  ...
  recipe = {
    {L("silverin_plate"), i.clay,           L("silverin_plate")},
